...
* Installer
  :PROPERTIES:
  :ID:       819f8775-1a36-4804-9472-9d91db4c4a0e
  :END:
  ...
  [[http://www.debian.org/devel/debian-installer/index.ja.html][Debian-Installer を使ったインストール]] より,
   ...
   を落としてくる.
   USB メモリを差して, これらを =dd= で書き込むとインストーラが作成される.
...
** インストール作業
   [[id:819f8775-1a36-4804-9472-9d91db4c4a0e][USBインストーラ]] を作成してインストールを進めます.
   時節柄, 丁度 Stretch installer の RC2 が出ていたので, テストにもなりました.

   言語設定で「Japanese - 日本語」を選ぶと, lvremove ができないのは相変わらずでしたが,
   それ以外は特に気になる所もなく.
