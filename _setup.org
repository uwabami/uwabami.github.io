...
#+MACRO: twitter @@html:<a href="https://twitter.com/$1/"><i class="fab fa-twitter twitter"></i></a>@@
#+MACRO: github  @@html:<a href="https://github.com/$1/"><i class="fab fa-github github"></i></a>@@
#+MACRO: fb  @@html:<a href="https://facebook.com/$1/"><i class="fab fa-facebook facebook"></i></a>@@
#+MACRO: keybase @@html:<a href="https://keybase.io/$1/"><i class="fab fa-keybase keybase"></i></a>@@
#+MACRO: mstdn @@html:<a rel="me" href="https://junkhub.org/$1"><i class="fab fa-mastodon mastodon"></i></a>@@
