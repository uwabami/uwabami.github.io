...
#+MACRO: envelope @@html:<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <a href="mailto:$1">$1</a>@@
#+MACRO: twitter @@html:<a href="https://twitter.com/$1/" target="_blank"><i class="icon-twitter twitter"></i></a>@@
#+MACRO: github  @@html:<a href="https://github.com/$1/" target="_blank"><i class="icon-github github"></i></a>@@
#+MACRO: fb  @@html:<a href="https://facebook.com/$1/" target="_blank"><i class="icon-facebook facebook"></i></a>@@
#+MACRO: keybase @@html:<a href="https://keybase.io/$1/" target="_blank"><i class="icon-key keybase"></i></a>@@
